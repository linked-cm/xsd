...
var _this = __importStar(require("./xsd.js"));
var dataFile = '../data/xsd.json';
var loadData = function () {
    if (typeof module !== 'undefined' && typeof exports !== 'undefined') {
        return Promise.resolve().then(function () { return __importStar(require('../data/xsd.json')); });
    }
    //@ts-ignore
    return Promise.resolve().then(function () { return __importStar(require('../data/xsd.json')); }).then(function (data) { return data.default; });
};
